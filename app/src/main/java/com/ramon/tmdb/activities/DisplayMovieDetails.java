...
public class DisplayMovieDetails extends AppCompatActivity {
    ...
    private void loadJSON() {
        ...
        Call<MovieDetail> call = getMovie.getMovie(id, RetrofitInstance.getApiKey());
        ...
        call.enqueue(new Callback<MovieDetail>() {
            ...
            public void onResponse(Call<MovieDetail> call, Response<MovieDetail> response) {
                switch (response.code()) {
                    case 200:
                        ...
                        tvDuration.setText("Duration: " + (int) data.getRuntime() + " min");
            ...
            public void onFailure(Call<MovieDetail> call, Throwable t) {
                Toast.makeText(DisplayMovieDetails.this, "Loading error, try again later", Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    private void loadCredits() {
        GetMovie getMovie = RetrofitInstance.getRetrofitInstance().create(GetMovie.class);
        Call<CreditsFeed> call = getMovie.getCredits(id, RetrofitInstance.getApiKey());
            ...
            public void onResponse(Call<CreditsFeed> call, Response<CreditsFeed> response) {
                switch (response.code()) {
                    case 200:
                        ...
                        RecyclerView.LayoutManager layoutManager = new LinearLayoutManager(DisplayMovieDetails.this);
